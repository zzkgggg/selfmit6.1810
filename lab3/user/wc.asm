...
wc(int fd, char *name)
{
  ...
  3c:	908a0a13          	add	s4,s4,-1784 # 940 <malloc+0xea>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	8b250513          	add	a0,a0,-1870 # 958 <malloc+0x102>
  ...
  d8:	87450513          	add	a0,a0,-1932 # 948 <malloc+0xf2>
...
main(int argc, char *argv[])
{
 ...
 154:	81858593          	add	a1,a1,-2024 # 968 <malloc+0x112>
 158:	4501                	li	a0,0
 ...
 174:	80050513          	add	a0,a0,-2048 # 970 <malloc+0x11a>
...
ugetpid(void)
{
 ...
 412:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffeded>
 414:	07b2                	sll	a5,a5,0xc
 416:	4388                	lw	a0,0(a5)
 418:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 51e:	4ce50513          	add	a0,a0,1230 # 9e8 <digits>
 522:	883a                	mv	a6,a4
 524:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ac:	340b8b93          	add	s7,s7,832 # 9e8 <digits>
 ...
 700:	28c90913          	add	s2,s2,652 # 988 <malloc+0x132>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8b2:	96278793          	add	a5,a5,-1694 # 1210 <base>
