...
main(int argc, char *argv[])
{
  ...
  40:	7f458593          	add	a1,a1,2036 # 830 <malloc+0xee>
  44:	4509                	li	a0,2
  ...
  5e:	7ee58593          	add	a1,a1,2030 # 848 <malloc+0x106>
  62:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2fe:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefed>
 300:	07b2                	sll	a5,a5,0xc
 302:	4388                	lw	a0,0(a5)
 304:	6422                	ld	s0,8(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50e:	36670713          	add	a4,a4,870 # 870 <malloc+0x12e>
 ...
 598:	334b8b93          	add	s7,s7,820 # 8c8 <digits>
 ...
 5ec:	28090913          	add	s2,s2,640 # 868 <malloc+0x126>
        while(*s != 0){
