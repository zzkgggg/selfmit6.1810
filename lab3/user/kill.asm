...
main(int argc, char **argv)
{
  ...
  4c:	7d858593          	add	a1,a1,2008 # 820 <malloc+0xf0>
  50:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2ec:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefed>
 2ee:	07b2                	sll	a5,a5,0xc
 2f0:	4388                	lw	a0,0(a5)
 2f2:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f8:	4a450513          	add	a0,a0,1188 # 898 <digits>
 3fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fc:	34870713          	add	a4,a4,840 # 840 <malloc+0x110>
 ...
 586:	316b8b93          	add	s7,s7,790 # 898 <digits>
 ...
 5da:	26290913          	add	s2,s2,610 # 838 <malloc+0x108>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 73e:	e456                	sd	s5,8(sp)
 740:	e05a                	sd	s6,0(sp)
 742:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 744:	02051493          	sll	s1,a0,0x20
 748:	9081                	srl	s1,s1,0x20
 74a:	04bd                	add	s1,s1,15
 74c:	8091                	srl	s1,s1,0x4
 74e:	0014899b          	addw	s3,s1,1
 752:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 7a8:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7aa:	02071693          	sll	a3,a4,0x20
 7ae:	01c6d713          	srl	a4,a3,0x1c
