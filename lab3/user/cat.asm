...
cat(int fd)
{
  ...
  44:	89058593          	add	a1,a1,-1904 # 8d0 <malloc+0xe8>
  48:	4509                	li	a0,2
  ...
  72:	87a58593          	add	a1,a1,-1926 # 8e8 <malloc+0x100>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	80058593          	add	a1,a1,-2048 # 900 <malloc+0x118>
 108:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 3a4:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffeded>
 3a6:	07b2                	sll	a5,a5,0xc
 3a8:	4388                	lw	a0,0(a5)
 3aa:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b0:	4cc50513          	add	a0,a0,1228 # 978 <digits>
 4b4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b4:	37070713          	add	a4,a4,880 # 920 <malloc+0x138>
 ...
 63e:	33eb8b93          	add	s7,s7,830 # 978 <digits>
 ...
 692:	28a90913          	add	s2,s2,650 # 918 <malloc+0x130>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 844:	9d078793          	add	a5,a5,-1584 # 1210 <base>
 ...
 860:	c798                	sw	a4,8(a5)
        p += p->s.size;
 862:	02071693          	sll	a3,a4,0x20
 866:	01c6d713          	srl	a4,a3,0x1c
