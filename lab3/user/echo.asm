...
main(int argc, char *argv[])
{
  ...
  34:	810a8a93          	add	s5,s5,-2032 # 840 <malloc+0xe6>
  ...
  76:	7d658593          	add	a1,a1,2006 # 848 <malloc+0xee>
  7a:	4505                	li	a0,1
...
ugetpid(void)
{
 ...
 316:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefed>
 318:	07b2                	sll	a5,a5,0xc
 31a:	4388                	lw	a0,0(a5)
 31c:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	49250513          	add	a0,a0,1170 # 8b0 <digits>
 426:	883a                	mv	a6,a4
 428:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 526:	33670713          	add	a4,a4,822 # 858 <malloc+0xfe>
 ...
 5b0:	304b8b93          	add	s7,s7,772 # 8b0 <digits>
 ...
 604:	25090913          	add	s2,s2,592 # 850 <malloc+0xf6>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 768:	e456                	sd	s5,8(sp)
 76a:	e05a                	sd	s6,0(sp)
 76c:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 76e:	02051493          	sll	s1,a0,0x20
 772:	9081                	srl	s1,s1,0x20
 774:	04bd                	add	s1,s1,15
 776:	8091                	srl	s1,s1,0x4
 778:	0014899b          	addw	s3,s1,1
 77c:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 7b6:	85e78793          	add	a5,a5,-1954 # 1010 <base>
 ...
 7d2:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7d4:	02071693          	sll	a3,a4,0x20
 7d8:	01c6d713          	srl	a4,a3,0x1c
