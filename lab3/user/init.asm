...
main(void)
{
  ...
  12:	8a250513          	add	a0,a0,-1886 # 8b0 <malloc+0xec>
  ...
  3a:	88290913          	add	s2,s2,-1918 # 8b8 <malloc+0xf4>
  3e:	854a                	mv	a0,s2
  ...
  6e:	89e50513          	add	a0,a0,-1890 # 908 <malloc+0x144>
  ...
  8c:	82850513          	add	a0,a0,-2008 # 8b0 <malloc+0xec>
  90:	00000097          	auipc	ra,0x0
  94:	34c080e7          	jalr	844(ra) # 3dc <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	81650513          	add	a0,a0,-2026 # 8b0 <malloc+0xec>
  a2:	00000097          	auipc	ra,0x0
  a6:	332080e7          	jalr	818(ra) # 3d4 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	82450513          	add	a0,a0,-2012 # 8d0 <malloc+0x10c>
  ...
  d2:	81a50513          	add	a0,a0,-2022 # 8e8 <malloc+0x124>
  d6:	00000097          	auipc	ra,0x0
  da:	2f6080e7          	jalr	758(ra) # 3cc <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	81250513          	add	a0,a0,-2030 # 8f0 <malloc+0x12c>
...
ugetpid(void)
{
 ...
 380:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefdd>
 382:	07b2                	sll	a5,a5,0xc
 384:	4388                	lw	a0,0(a5)
 386:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48c:	50050513          	add	a0,a0,1280 # 988 <digits>
 490:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 590:	3a470713          	add	a4,a4,932 # 930 <malloc+0x16c>
 ...
 61a:	372b8b93          	add	s7,s7,882 # 988 <digits>
 ...
 66e:	2be90913          	add	s2,s2,702 # 928 <malloc+0x164>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 814:	80090913          	add	s2,s2,-2048 # 1010 <freep>
  if(p == (char*)-1)
 818:	5afd                	li	s5,-1
 81a:	a895                	j	88e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 81c:	00001797          	auipc	a5,0x1
 820:	80478793          	add	a5,a5,-2044 # 1020 <base>
