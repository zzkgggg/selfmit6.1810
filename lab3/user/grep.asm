...
00000000000001ec <main>:
{
 ...
 25e:	80658593          	add	a1,a1,-2042 # a60 <malloc+0xea>
 262:	4509                	li	a0,2
 ...
 294:	7f050513          	add	a0,a0,2032 # a80 <malloc+0x10a>
...
ugetpid(void)
{
 ...
 532:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffebed>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 63e:	4be50513          	add	a0,a0,1214 # af8 <digits>
 642:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 742:	36270713          	add	a4,a4,866 # aa0 <malloc+0x12a>
 ...
 7cc:	330b8b93          	add	s7,s7,816 # af8 <digits>
 ...
 820:	27c90913          	add	s2,s2,636 # a98 <malloc+0x122>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 984:	e456                	sd	s5,8(sp)
 986:	e05a                	sd	s6,0(sp)
 988:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 98a:	02051493          	sll	s1,a0,0x20
 98e:	9081                	srl	s1,s1,0x20
 990:	04bd                	add	s1,s1,15
 992:	8091                	srl	s1,s1,0x4
 994:	0014899b          	addw	s3,s1,1
 998:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 9c6:	63e90913          	add	s2,s2,1598 # 1000 <freep>
  if(p == (char*)-1)
 9ca:	5afd                	li	s5,-1
 9cc:	a895                	j	a40 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9ce:	00001797          	auipc	a5,0x1
 9d2:	a4278793          	add	a5,a5,-1470 # 1410 <base>
 ...
 9ee:	c798                	sw	a4,8(a5)
        p += p->s.size;
 9f0:	02071693          	sll	a3,a4,0x20
 9f4:	01c6d713          	srl	a4,a3,0x1c
