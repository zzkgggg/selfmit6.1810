...
ugetpid(void)
{
 ...
 2b2:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefed>
 2b4:	07b2                	sll	a5,a5,0xc
 2b6:	4388                	lw	a0,0(a5)
 2b8:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	48650513          	add	a0,a0,1158 # 840 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c2:	32a70713          	add	a4,a4,810 # 7e8 <malloc+0xf2>
 ...
 54c:	2f8b8b93          	add	s7,s7,760 # 840 <digits>
 ...
 5a0:	24490913          	add	s2,s2,580 # 7e0 <malloc+0xea>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 746:	8be90913          	add	s2,s2,-1858 # 1000 <freep>
  if(p == (char*)-1)
 74a:	5afd                	li	s5,-1
 74c:	a895                	j	7c0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 74e:	00001797          	auipc	a5,0x1
 752:	8c278793          	add	a5,a5,-1854 # 1010 <base>
