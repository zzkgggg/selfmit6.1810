...
err(char *why)
{
  ...
  28:	99c50513          	add	a0,a0,-1636 # 9c0 <malloc+0xf0>
...
ugetpid_test()
{
  ...
  4c:	9a050513          	add	a0,a0,-1632 # 9e8 <malloc+0x118>
  50:	00000097          	auipc	ra,0x0
  54:	7c8080e7          	jalr	1992(ra) # 818 <printf>
  testname = "ugetpid_test";
  58:	00001797          	auipc	a5,0x1
  5c:	9a878793          	add	a5,a5,-1624 # a00 <malloc+0x130>
  ...
  94:	99050513          	add	a0,a0,-1648 # a20 <malloc+0x150>
  ...
  ce:	94650513          	add	a0,a0,-1722 # a10 <malloc+0x140>
...
pgaccess_test()
{
  ...
  f2:	94a50513          	add	a0,a0,-1718 # a38 <malloc+0x168>
  f6:	00000097          	auipc	ra,0x0
  fa:	722080e7          	jalr	1826(ra) # 818 <printf>
  testname = "pgaccess_test";
  fe:	00001797          	auipc	a5,0x1
 102:	95278793          	add	a5,a5,-1710 # a50 <malloc+0x180>
 ...
 178:	0799                	add	a5,a5,6 # 40000006 <base+0x3fffefe6>
 ...
 18c:	90850513          	add	a0,a0,-1784 # a90 <malloc+0x1c0>
 ...
 1a6:	8be50513          	add	a0,a0,-1858 # a60 <malloc+0x190>
 1aa:	00000097          	auipc	ra,0x0
 1ae:	e56080e7          	jalr	-426(ra) # 0 <err>
    err("pgaccess failed");
 1b2:	00001517          	auipc	a0,0x1
 1b6:	8ae50513          	add	a0,a0,-1874 # a60 <malloc+0x190>
 1ba:	00000097          	auipc	ra,0x0
 1be:	e46080e7          	jalr	-442(ra) # 0 <err>
    err("incorrect access bits set");
 1c2:	00001517          	auipc	a0,0x1
 1c6:	8ae50513          	add	a0,a0,-1874 # a70 <malloc+0x1a0>
...
00000000000001d2 <main>:
{
 ...
 1ee:	8be50513          	add	a0,a0,-1858 # aa8 <malloc+0x1d8>
...
ugetpid(void)
{
 ...
 48c:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefdd>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 598:	59c50513          	add	a0,a0,1436 # b30 <digits>
 59c:	883a                	mv	a6,a4
 59e:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 726:	40eb8b93          	add	s7,s7,1038 # b30 <digits>
 ...
 77a:	35a90913          	add	s2,s2,858 # ad0 <malloc+0x200>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 920:	6f490913          	add	s2,s2,1780 # 1010 <freep>
  if(p == (char*)-1)
 924:	5afd                	li	s5,-1
 926:	a895                	j	99a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 928:	00000797          	auipc	a5,0x0
 92c:	6f878793          	add	a5,a5,1784 # 1020 <base>
