...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	31e58593          	add	a1,a1,798 # 1330 <malloc+0xf4>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d858593          	add	a1,a1,728 # 1338 <malloc+0xfc>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2a650513          	add	a0,a0,678 # 1340 <malloc+0x104>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37a70713          	add	a4,a4,890 # 1440 <malloc+0x204>
    ...
    panic("runcmd");
      ...
      e4:	26850513          	add	a0,a0,616 # 1348 <malloc+0x10c>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24e58593          	add	a1,a1,590 # 1350 <malloc+0x114>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	21258593          	add	a1,a1,530 # 1360 <malloc+0x124>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	18c50513          	add	a0,a0,396 # 1370 <malloc+0x134>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	de2b8b93          	add	s7,s7,-542 # 1398 <malloc+0x15c>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	db050513          	add	a0,a0,-592 # 1378 <malloc+0x13c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	cf060613          	add	a2,a2,-784 # 13a0 <malloc+0x164>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	ce0b0b13          	add	s6,s6,-800 # 13c0 <malloc+0x184>
  ...
  return ret;
     ...
     71e:	c8e50513          	add	a0,a0,-882 # 13a8 <malloc+0x16c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c3450513          	add	a0,a0,-972 # 13b0 <malloc+0x174>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c1260613          	add	a2,a2,-1006 # 13c8 <malloc+0x18c>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	baaa0a13          	add	s4,s4,-1110 # 13d0 <malloc+0x194>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b7c60613          	add	a2,a2,-1156 # 13d8 <malloc+0x19c>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	ade60613          	add	a2,a2,-1314 # 13a0 <malloc+0x164>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	afe60613          	add	a2,a2,-1282 # 13f0 <malloc+0x1b4>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ae870713          	add	a4,a4,-1304 # 1458 <malloc+0x21c>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	9f460613          	add	a2,a2,-1548 # 1410 <malloc+0x1d4>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	9c658593          	add	a1,a1,-1594 # 1418 <malloc+0x1dc>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	6fa080e7          	jalr	1786(ra) # 1156 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	94450513          	add	a0,a0,-1724 # 13a8 <malloc+0x16c>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	9a448493          	add	s1,s1,-1628 # 1428 <malloc+0x1ec>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	8f658593          	add	a1,a1,-1802 # 1430 <malloc+0x1f4>
     b42:	4509                	li	a0,2
...
ugetpid(void)
{
  ...
  return u->pid;
     ...
     df8:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffdf75>
     dfa:	07b2                	sll	a5,a5,0xc
     dfc:	4388                	lw	a0,0(a5)
     dfe:	6422                	ld	s0,8(sp)
     e00:	0141                	add	sp,sp,16
     e02:	8082                	ret
...
putc(int fd, char c)
{
     ebc:	1101                	add	sp,sp,-32
     ebe:	ec06                	sd	ra,24(sp)
     ec0:	e822                	sd	s0,16(sp)
     ec2:	1000                	add	s0,sp,32
     ec4:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     ec8:	4605                	li	a2,1
     eca:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f04:	5d050513          	add	a0,a0,1488 # 14d0 <digits>
     f08:	883a                	mv	a6,a4
  ...
  while(--i >= 0)
     ...
     f48:	fc040793          	add	a5,s0,-64
     f4c:	00e78933          	add	s2,a5,a4
     f50:	fff78993          	add	s3,a5,-1
     f54:	99ba                	add	s3,s3,a4
     f56:	377d                	addw	a4,a4,-1
     f58:	1702                	sll	a4,a4,0x20
     f5a:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ff4:	f9d9079b          	addw	a5,s2,-99
     ff8:	0ff7f713          	zext.b	a4,a5
     ffc:	10eb6f63          	bltu	s6,a4,111a <vprintf+0x190>
    1000:	00271793          	sll	a5,a4,0x2
    1004:	00000717          	auipc	a4,0x0
    1008:	47470713          	add	a4,a4,1140 # 1478 <malloc+0x23c>
  ...
  putc(fd, 'x');
    ...
    1092:	442b8b93          	add	s7,s7,1090 # 14d0 <digits>
    1096:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10aa:	0992                	sll	s3,s3,0x4
    10ac:	397d                	addw	s2,s2,-1
    ...
    10e6:	38e90913          	add	s2,s2,910 # 1470 <malloc+0x234>
        while(*s != 0){
...
{
    1156:	715d                	add	sp,sp,-80
    1158:	ec06                	sd	ra,24(sp)
    115a:	e822                	sd	s0,16(sp)
    115c:	1000                	add	s0,sp,32
...
{
    1184:	711d                	add	sp,sp,-96
    1186:	ec06                	sd	ra,24(sp)
    1188:	e822                	sd	s0,16(sp)
    118a:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11ba:	1141                	add	sp,sp,-16
    11bc:	e422                	sd	s0,8(sp)
    11be:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11c0:	ff050693          	add	a3,a0,-16
    ...
    11f0:	00e6ea63          	bltu	a3,a4,1204 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    120a:	02059813          	sll	a6,a1,0x20
    120e:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    121e:	02061593          	sll	a1,a2,0x20
    1222:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    ...
    124e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1250:	02051493          	sll	s1,a0,0x20
    1254:	9081                	srl	s1,s1,0x20
    1256:	04bd                	add	s1,s1,15
    1258:	8091                	srl	s1,s1,0x4
    125a:	0014899b          	addw	s3,s1,1
    125e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    128c:	d8890913          	add	s2,s2,-632 # 2010 <freep>
  if(p == (char*)-1)
    1290:	5afd                	li	s5,-1
    1292:	a895                	j	1306 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    1294:	00001797          	auipc	a5,0x1
    1298:	df478793          	add	a5,a5,-524 # 2088 <base>
    ...
    12b4:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12b6:	02071693          	sll	a3,a4,0x20
    12ba:	01c6d713          	srl	a4,a3,0x1c
