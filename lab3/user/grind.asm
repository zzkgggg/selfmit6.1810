...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2c650513          	add	a0,a0,710 # 1360 <malloc+0xec>
      a2:	00001097          	auipc	ra,0x1
      a6:	e0a080e7          	jalr	-502(ra) # eac <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2b650513          	add	a0,a0,694 # 1360 <malloc+0xec>
      b2:	00001097          	auipc	ra,0x1
      b6:	e02080e7          	jalr	-510(ra) # eb4 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2ac50513          	add	a0,a0,684 # 1368 <malloc+0xf4>
  ...
  chdir("/");
      ...
      da:	2b250513          	add	a0,a0,690 # 1388 <malloc+0x114>
      de:	00001097          	auipc	ra,0x1
      e2:	dd6080e7          	jalr	-554(ra) # eb4 <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	2b298993          	add	s3,s3,690 # 1398 <malloc+0x124>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2a098993          	add	s3,s3,672 # 1390 <malloc+0x11c>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	54c90913          	add	s2,s2,1356 # 1648 <malloc+0x3d4>
    ...
    if(what == 1){
     ...
     10e:	29650513          	add	a0,a0,662 # 13a0 <malloc+0x12c>
    ...
    if(what == 1){
     ...
     168:	24c50513          	add	a0,a0,588 # 13b0 <malloc+0x13c>
     ...
     182:	22250513          	add	a0,a0,546 # 13a0 <malloc+0x12c>
     ...
     194:	1d050513          	add	a0,a0,464 # 1360 <malloc+0xec>
     ...
     1a6:	22650513          	add	a0,a0,550 # 13c8 <malloc+0x154>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cea080e7          	jalr	-790(ra) # e94 <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1d650513          	add	a0,a0,470 # 1388 <malloc+0x114>
     1ba:	00001097          	auipc	ra,0x1
     1be:	cfa080e7          	jalr	-774(ra) # eb4 <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	1a450513          	add	a0,a0,420 # 1368 <malloc+0xf4>
     ...
     1f0:	1e450513          	add	a0,a0,484 # 13d0 <malloc+0x15c>
     ...
     212:	1d250513          	add	a0,a0,466 # 13e0 <malloc+0x16c>
     ...
     256:	14e50513          	add	a0,a0,334 # 13a0 <malloc+0x12c>
     25a:	00001097          	auipc	ra,0x1
     25e:	c52080e7          	jalr	-942(ra) # eac <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	19250513          	add	a0,a0,402 # 13f8 <malloc+0x184>
     ...
     282:	18a50513          	add	a0,a0,394 # 1408 <malloc+0x194>
     ...
     294:	18050513          	add	a0,a0,384 # 1410 <malloc+0x19c>
     298:	00001097          	auipc	ra,0x1
     29c:	c14080e7          	jalr	-1004(ra) # eac <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	17450513          	add	a0,a0,372 # 1418 <malloc+0x1a4>
     ...
     2c0:	16c50513          	add	a0,a0,364 # 1428 <malloc+0x1b4>
     ...
     2d2:	12250513          	add	a0,a0,290 # 13f0 <malloc+0x17c>
     2d6:	00001097          	auipc	ra,0x1
     2da:	bbe080e7          	jalr	-1090(ra) # e94 <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	0ea58593          	add	a1,a1,234 # 13c8 <malloc+0x154>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	14a50513          	add	a0,a0,330 # 1430 <malloc+0x1bc>
     ...
     2fc:	15050513          	add	a0,a0,336 # 1448 <malloc+0x1d4>
     300:	00001097          	auipc	ra,0x1
     304:	b94080e7          	jalr	-1132(ra) # e94 <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0c858593          	add	a1,a1,200 # 13d0 <malloc+0x15c>
     310:	00001517          	auipc	a0,0x1
     314:	14850513          	add	a0,a0,328 # 1458 <malloc+0x1e4>
     ...
     348:	11c50513          	add	a0,a0,284 # 1460 <malloc+0x1ec>
     ...
     396:	0ce50513          	add	a0,a0,206 # 1460 <malloc+0x1ec>
     ...
     3f6:	08650513          	add	a0,a0,134 # 1478 <malloc+0x204>
     ...
     422:	02250513          	add	a0,a0,34 # 1440 <malloc+0x1cc>
     ...
     444:	02050513          	add	a0,a0,32 # 1460 <malloc+0x1ec>
     ...
     45e:	02e50513          	add	a0,a0,46 # 1488 <malloc+0x214>
     ...
     4ac:	fb850513          	add	a0,a0,-72 # 1460 <malloc+0x1ec>
     ...
     508:	f9c50513          	add	a0,a0,-100 # 14a0 <malloc+0x22c>
     ...
     534:	f8858593          	add	a1,a1,-120 # 14b8 <malloc+0x244>
     ...
     636:	e2e50513          	add	a0,a0,-466 # 1460 <malloc+0x1ec>
     ...
     650:	eb450513          	add	a0,a0,-332 # 1500 <malloc+0x28c>
     ...
     664:	ea050513          	add	a0,a0,-352 # 1500 <malloc+0x28c>
     ...
     67c:	e4058593          	add	a1,a1,-448 # 14b8 <malloc+0x244>
     ...
     6c2:	e4250513          	add	a0,a0,-446 # 1500 <malloc+0x28c>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7ce080e7          	jalr	1998(ra) # e94 <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e3850513          	add	a0,a0,-456 # 1508 <malloc+0x294>
     ...
     6ee:	e3650513          	add	a0,a0,-458 # 1520 <malloc+0x2ac>
     ...
     708:	e3450513          	add	a0,a0,-460 # 1538 <malloc+0x2c4>
     ...
     724:	e3050513          	add	a0,a0,-464 # 1550 <malloc+0x2dc>
     ...
     73e:	e3e50513          	add	a0,a0,-450 # 1578 <malloc+0x304>
     ...
     826:	df658593          	add	a1,a1,-522 # 1618 <malloc+0x3a4>
     ...
     84a:	dda50513          	add	a0,a0,-550 # 1620 <malloc+0x3ac>
     ...
     864:	c4058593          	add	a1,a1,-960 # 14a0 <malloc+0x22c>
     868:	4509                	li	a0,2
     ...
     880:	c2458593          	add	a1,a1,-988 # 14a0 <malloc+0x22c>
     884:	4509                	li	a0,2
     ...
     8dc:	cc858593          	add	a1,a1,-824 # 15a0 <malloc+0x32c>
     8e0:	4509                	li	a0,2
     ...
     950:	b1458593          	add	a1,a1,-1260 # 1460 <malloc+0x1ec>
     954:	4509                	li	a0,2
     ...
     99c:	c0858593          	add	a1,a1,-1016 # 15a0 <malloc+0x32c>
     9a0:	4509                	li	a0,2
     ...
     9e0:	bc458593          	add	a1,a1,-1084 # 15a0 <malloc+0x32c>
     9e4:	4509                	li	a0,2
     ...
     a48:	a1c58593          	add	a1,a1,-1508 # 1460 <malloc+0x1ec>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9d450513          	add	a0,a0,-1580 # 1440 <malloc+0x1cc>
     a74:	00000097          	auipc	ra,0x0
     a78:	420080e7          	jalr	1056(ra) # e94 <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	97450513          	add	a0,a0,-1676 # 13f0 <malloc+0x17c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	9aa50513          	add	a0,a0,-1622 # 1460 <malloc+0x1ec>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	96250513          	add	a0,a0,-1694 # 1460 <malloc+0x1ec>
...
ugetpid(void)
{
  ...
  return u->pid;
     ...
     e30:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffdbf5>
     e32:	07b2                	sll	a5,a5,0xc
     e34:	4388                	lw	a0,0(a5)
     e36:	6422                	ld	s0,8(sp)
     e38:	0141                	add	sp,sp,16
     e3a:	8082                	ret
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f3c:	7d050513          	add	a0,a0,2000 # 1708 <digits>
     f40:	883a                	mv	a6,a4
     f42:	2705                	addw	a4,a4,1
     f44:	02c5f7bb          	remuw	a5,a1,a2
     f48:	1782                	sll	a5,a5,0x20
     f4a:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    10ca:	642b8b93          	add	s7,s7,1602 # 1708 <digits>
    10ce:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10e2:	0992                	sll	s3,s3,0x4
    10e4:	397d                	addw	s2,s2,-1
    ...
    111e:	58e90913          	add	s2,s2,1422 # 16a8 <malloc+0x434>
        while(*s != 0){
...
{
    118e:	715d                	add	sp,sp,-80
    1190:	ec06                	sd	ra,24(sp)
    1192:	e822                	sd	s0,16(sp)
    1194:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11f2:	1141                	add	sp,sp,-16
    11f4:	e422                	sd	s0,8(sp)
    11f6:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11f8:	ff050693          	add	a3,a0,-16
    ...
    1228:	00e6ea63          	bltu	a3,a4,123c <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1242:	02059813          	sll	a6,a1,0x20
    1246:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1256:	02061593          	sll	a1,a2,0x20
    125a:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    ...
    1286:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1288:	02051493          	sll	s1,a0,0x20
    128c:	9081                	srl	s1,s1,0x20
    128e:	04bd                	add	s1,s1,15
    1290:	8091                	srl	s1,s1,0x4
    1292:	0014899b          	addw	s3,s1,1
    1296:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12c4:	d5090913          	add	s2,s2,-688 # 2010 <freep>
  if(p == (char*)-1)
    12c8:	5afd                	li	s5,-1
    12ca:	a895                	j	133e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12cc:	00001797          	auipc	a5,0x1
    12d0:	13c78793          	add	a5,a5,316 # 2408 <base>
    ...
    12ec:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12ee:	02071693          	sll	a3,a4,0x20
    12f2:	01c6d713          	srl	a4,a3,0x1c
