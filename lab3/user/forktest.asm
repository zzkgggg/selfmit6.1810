...
forktest(void)
{
  ...
  3e:	43650513          	add	a0,a0,1078 # 470 <pgaccess+0xe>
  ...
  68:	41c50513          	add	a0,a0,1052 # 480 <pgaccess+0x1e>
  ...
  b8:	41c50513          	add	a0,a0,1052 # 4d0 <pgaccess+0x6e>
  ...
  d4:	3d050513          	add	a0,a0,976 # 4a0 <pgaccess+0x3e>
  ...
  ee:	3ce50513          	add	a0,a0,974 # 4b8 <pgaccess+0x56>
...
ugetpid(void)
{
 ...
 3a6:	17f5                	add	a5,a5,-3 # 3fffffd <__global_pointer$+0x3fff31f>
 3a8:	07b2                	sll	a5,a5,0xc
 3aa:	4388                	lw	a0,0(a5)
 3ac:	6422                	ld	s0,8(sp)
