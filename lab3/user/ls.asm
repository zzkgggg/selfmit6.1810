...
ls(char *path)
{
 ...
 128:	99c50513          	add	a0,a0,-1636 # ac0 <malloc+0x122>
 ...
 166:	92e58593          	add	a1,a1,-1746 # a90 <malloc+0xf2>
 16a:	4509                	li	a0,2
 ...
 17c:	93058593          	add	a1,a1,-1744 # aa8 <malloc+0x10a>
 180:	4509                	li	a0,2
 ...
 1ae:	92650513          	add	a0,a0,-1754 # ad0 <malloc+0x132>
 ...
 1f2:	8faa0a13          	add	s4,s4,-1798 # ae8 <malloc+0x14a>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	8b2a8a93          	add	s5,s5,-1870 # aa8 <malloc+0x10a>
...
main(int argc, char *argv[])
{
 ...
 2bc:	84050513          	add	a0,a0,-1984 # af8 <malloc+0x15a>
...
ugetpid(void)
{
 ...
 55a:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefdd>
 55c:	07b2                	sll	a5,a5,0xc
 55e:	4388                	lw	a0,0(a5)
 560:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 666:	4fe50513          	add	a0,a0,1278 # b60 <digits>
 66a:	883a                	mv	a6,a4
 ...
 6aa:	fc040793          	add	a5,s0,-64
 6ae:	00e78933          	add	s2,a5,a4
 6b2:	fff78993          	add	s3,a5,-1
 6b6:	99ba                	add	s3,s3,a4
 6b8:	377d                	addw	a4,a4,-1
 6ba:	1702                	sll	a4,a4,0x20
 6bc:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7f4:	370b8b93          	add	s7,s7,880 # b60 <digits>
 7f8:	03c9d793          	srl	a5,s3,0x3c
 ...
 80c:	0992                	sll	s3,s3,0x4
 80e:	397d                	addw	s2,s2,-1
 ...
 848:	2bc90913          	add	s2,s2,700 # b00 <malloc+0x162>
        while(*s != 0){
 84c:	02800593          	li	a1,40
 850:	bff1                	j	82c <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
 852:	008b8913          	add	s2,s7,8
