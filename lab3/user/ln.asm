...
main(int argc, char *argv[])
{
  ...
  14:	81058593          	add	a1,a1,-2032 # 820 <malloc+0xf4>
  18:	4509                	li	a0,2
  ...
  50:	7ec58593          	add	a1,a1,2028 # 838 <malloc+0x10c>
  54:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2e8:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffefed>
 2ea:	07b2                	sll	a5,a5,0xc
 2ec:	4388                	lw	a0,0(a5)
 2ee:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	4c050513          	add	a0,a0,1216 # 8b0 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	36470713          	add	a4,a4,868 # 858 <malloc+0x12c>
 ...
 582:	332b8b93          	add	s7,s7,818 # 8b0 <digits>
 ...
 5d6:	27e90913          	add	s2,s2,638 # 850 <malloc+0x124>
        while(*s != 0){
