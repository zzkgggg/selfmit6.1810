...
main(int argc, char *argv[])
{
  ...
  32:	83258593          	add	a1,a1,-1998 # 860 <malloc+0xea>
  36:	4509                	li	a0,2
  ...
  a8:	7d458593          	add	a1,a1,2004 # 878 <malloc+0x102>
  ac:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43e:	4b650513          	add	a0,a0,1206 # 8f0 <digits>
 442:	883a                	mv	a6,a4
 444:	2705                	addw	a4,a4,1
 446:	02c5f7bb          	remuw	a5,a1,a2
 44a:	1782                	sll	a5,a5,0x20
 44c:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53a:	00271793          	sll	a5,a4,0x2
 53e:	00000717          	auipc	a4,0x0
 542:	35a70713          	add	a4,a4,858 # 898 <malloc+0x122>
 ...
 5cc:	328b8b93          	add	s7,s7,808 # 8f0 <digits>
 ...
 620:	27490913          	add	s2,s2,628 # 890 <malloc+0x11a>
        while(*s != 0){
