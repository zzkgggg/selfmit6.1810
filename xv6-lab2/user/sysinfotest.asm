...
sinfo(struct sysinfo *info) {
  ...
  20:	b5450513          	add	a0,a0,-1196 # b70 <malloc+0xfc>
...
countfree()
{
  ...
  aa:	ae250513          	add	a0,a0,-1310 # b88 <malloc+0x114>
...
testmem() {
 ...
 148:	a7c50513          	add	a0,a0,-1412 # bc0 <malloc+0x14c>
 ...
 162:	a9250513          	add	a0,a0,-1390 # bf0 <malloc+0x17c>
 ...
 17c:	a4850513          	add	a0,a0,-1464 # bc0 <malloc+0x14c>
 ...
 196:	a5e50513          	add	a0,a0,-1442 # bf0 <malloc+0x17c>
 ...
 1b2:	a1250513          	add	a0,a0,-1518 # bc0 <malloc+0x14c>
...
testcall() {
 ...
 202:	a0250513          	add	a0,a0,-1534 # c00 <malloc+0x18c>
 ...
 21c:	a0050513          	add	a0,a0,-1536 # c18 <malloc+0x1a4>
...
void testproc() {
 ...
 276:	9f650513          	add	a0,a0,-1546 # c68 <malloc+0x1f4>
 ...
 290:	9bc50513          	add	a0,a0,-1604 # c48 <malloc+0x1d4>
 ...
 2e0:	98c50513          	add	a0,a0,-1652 # c68 <malloc+0x1f4>
...
void testbad() {
 ...
 322:	92a50513          	add	a0,a0,-1750 # c48 <malloc+0x1d4>
 ...
 352:	94a50513          	add	a0,a0,-1718 # c98 <malloc+0x224>
...
main(int argc, char *argv[])
{
 ...
 380:	94450513          	add	a0,a0,-1724 # cc0 <malloc+0x24c>
 ...
 3a8:	93450513          	add	a0,a0,-1740 # cd8 <malloc+0x264>
...
atoi(const char *s)
{
 ...
 564:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
 566:	0705                	add	a4,a4,1
 568:	0025179b          	sllw	a5,a0,0x2
 56c:	9fa9                	addw	a5,a5,a0
 56e:	0017979b          	sllw	a5,a5,0x1
 572:	9fb5                	addw	a5,a5,a3
 574:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 578:	00074683          	lbu	a3,0(a4)
 57c:	fd06879b          	addw	a5,a3,-48
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 5a0:	1602                	sll	a2,a2,0x20
 5a2:	9201                	srl	a2,a2,0x20
 5a4:	00c507b3          	add	a5,a0,a2
  dst = vdst;
 5a8:	872a                	mv	a4,a0
      *dst++ = *src++;
 5aa:	0585                	add	a1,a1,1
 5ac:	0705                	add	a4,a4,1
 ...
 5ca:	fff6079b          	addw	a5,a2,-1
 5ce:	1782                	sll	a5,a5,0x20
 5d0:	9381                	srl	a5,a5,0x20
 5d2:	fff7c793          	not	a5,a5
 5d6:	97ba                	add	a5,a5,a4
      *--dst = *--src;
 5d8:	15fd                	add	a1,a1,-1
 5da:	177d                	add	a4,a4,-1
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 5f2:	fff6069b          	addw	a3,a2,-1
 5f6:	1682                	sll	a3,a3,0x20
 5f8:	9281                	srl	a3,a3,0x20
 5fa:	0685                	add	a3,a3,1
 ...
 606:	00e79863          	bne	a5,a4,616 <memcmp+0x2c>
    ...
    p1++;
 60a:	0505                	add	a0,a0,1
    p2++;
 60c:	0585                	add	a1,a1,1
  while (n-- > 0) {
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 73c:	61850513          	add	a0,a0,1560 # d50 <digits>
 740:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 840:	4bc70713          	add	a4,a4,1212 # cf8 <malloc+0x284>
 ...
 8ca:	48ab8b93          	add	s7,s7,1162 # d50 <digits>
 ...
 91e:	3d690913          	add	s2,s2,982 # cf0 <malloc+0x27c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 ac4:	54090913          	add	s2,s2,1344 # 1000 <freep>
  if(p == (char*)-1)
 ac8:	5afd                	li	s5,-1
 aca:	a895                	j	b3e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 acc:	00000797          	auipc	a5,0x0
 ad0:	54478793          	add	a5,a5,1348 # 1010 <base>
